...
class HomePage extends StatelessWidget {
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              Text('Angga', style: greyTextStyle.copyWith(fontSize: 16)),
  ...
  Widget buildServies(BuildContext context) {
    return Container(
      margin: const EdgeInsets.only(top: 30),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
            ...
            child: Column(
              children: [
                HomeLatestTransactionItem(
                  ...
                  title: 'Top Up',
                  time: 'Yesterday',
                  value: '+ ${formatCurrency(4900000, symbol: '')}',
                ),
                HomeLatestTransactionItem(
                ...
                HomeLatestTransactionItem(
                  ...
                  title: 'Transfer',
                  time: 'Aug 27',
                  value: '- ${formatCurrency(66000,symbol: '')}',
                ),
                HomeLatestTransactionItem(
          ...
          Wrap(
            ...
            children: [
              ...
              HomeTipsItem(
                ...
                url: Uri.parse('https://www.instagram.com/erlanggastrya_/'),
              ),
            ],
          ),
        ],
